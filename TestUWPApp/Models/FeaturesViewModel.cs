namespace SnooViewer.Models
{
    public partial class FeaturesViewModel
    {
        ...
        public DefaultSrsHoldoutViewModel DefaultSrsHoldout { get; set; }
        ...
        public DefaultSrsHoldoutViewModel EmailVerification { get; set; }
        public DefaultSrsHoldoutViewModel MwebXpromoRevampV2 { get; set; }
        ...
        public DefaultSrsHoldoutViewModel MwebSharingWebShareApi { get; set; }
